...
fun rookOrBishopThreatens(
    ...
    val equalityRookKing = kingX == rookX || kingY == rookY
    val equalityBishopKing = abs(kingX - bishopX) == abs(kingY - bishopY)
    val equalityBoth = equalityRookKing && equalityBishopKing
    return when {
        equalityBoth -> 3
        equalityRookKing -> 1
        equalityBishopKing -> 2
        else -> 0
    }
}
...
fun segmentLength(a: Int, b: Int, c: Int, d: Int): Int =
    when {
        (b < c && a < b && c < d) || (a == b || c == d) || (c < a && d < a) -> -1
        (c > a && c < b && b < d && b > c) || (a < c && b == d) || (a == c && b < d) -> b - c
        (b == d && c < a) || (a == c) -> b - a
        (a == c && d < b) || (a < c && d < b) -> d - c
        (c < a && d < b && d > a) -> d - a
        (c < a && b < d && a < b) -> b - a
        ((b == c && a < b && c < d) || a == b && b == c && c == d) -> 0
        else -> -1
    }
